 ...
 * Here, for each JUnit5 parallel tests this can be interpreted the following way- - a) Request
 * timestamp - When the test started execution - b) Response timestamp - When the test finished
 * execution - c) Response Delay(milli second) - (b-a) milli seconds - d) Scenario: Fully qualified
 * name of the Test-Class - e) Step: Name of the Test-Method in the above Test-Class
 * with @Test(jupiter package)
 *
 * <p>Later the logs are written to the target folder as raw JSON files ready for rendering
