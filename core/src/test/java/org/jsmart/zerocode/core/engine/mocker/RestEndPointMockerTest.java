...
public class RestEndPointMockerTest {
  ...
  @Rule public WireMockRule rule = new WireMockRule(9073);
  ...
  public void willDeserializeA_VanilaFlow() throws Exception {
    String jsonDocumentAsString =
        smartUtils.getJsonDocumentAsString(
            "wiremock_integration/wiremock_end_point_json_body.json");
    ScenarioSpec scenarioDeserialized =
        objectMapper.readValue(jsonDocumentAsString, ScenarioSpec.class);
    ...
    MockSteps mockSteps =
        smartUtils
            .getMapper()
            .readValue(
                scenarioDeserialized.getSteps().get(0).getRequest().toString(), MockSteps.class);
    ...
    JSONAssert.assertEquals(
        mockSteps.getMocks().get(0).getResponse().get("body").toString(),
        "{\n"
            + "                \"id\": \"p001\",\n"
            + "                \"source\": {\n"
            + "                  \"code\": \"GOOGLE.UK\"\n"
  ...
  public void willMockASimpleGetEndPoint() throws Exception {
    ...
    WireMock.configureFor(9073);
    givenThat(
        get(urlEqualTo(mockStep.getUrl()))
            .willReturn(
                aResponse()
    ...
    ClientRequest clientExecutor =
        httpClientExecutor.createRequest("http://localhost:9073" + mockStep.getUrl());
  ...
  public void willMockAPostRequest() throws Exception {
    ...
    final String bodyJson =
        mockPost.getRequest().get("body").toString(); // "{ \"id\" : \"p002\" }";
    stubFor(
        post(urlEqualTo(mockPost.getUrl()))
  ...
  public void willMockRequest_respond_with_contentType() throws Exception {
    ...
    CloseableHttpClient httpClient = HttpClients.createDefault();
    HttpGet request =
        new HttpGet("http://localhost:" + WIRE_MOCK_TEST_PORT + mockGetRequest.getUrl());
  ...
  public void willMockRequest_xmlBody() throws Exception {
    ...
    String jsonDocumentAsString =
        smartUtils.getJsonDocumentAsString(
            "wiremock_integration/wiremock_end_point_soap_xml_body.json");
    ScenarioSpec scenarioDeserialized =
        objectMapper.readValue(jsonDocumentAsString, ScenarioSpec.class);
    MockSteps mockSteps =
        smartUtils
    ...
    assertThat(
        responseBodyActual,
        containsString(
            "<ns2:description>It is a tablet computers designed, developed and marketed by Apple.</ns2:description>"));
  ...
  public void willMockASoapEndPoint() throws Exception {
    ...
    final MappingBuilder requestBuilder =
        post(urlEqualTo("/samples/testcomplete12/webservices/Service.asmx"));
    ...
    CloseableHttpClient httpClient = HttpClients.createDefault();
    HttpPost request =
        new HttpPost("http://localhost:9073" + "/samples/testcomplete12/webservices/Service.asmx");
