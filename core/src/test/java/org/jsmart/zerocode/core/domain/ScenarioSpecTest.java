...
public class ScenarioSpecTest {
  ...
  public void willDeserializeA_VanilaFlow() throws Exception {
    String jsonDocumentAsString =
        smartUtils.getJsonDocumentAsString("01_unit_test_jsons/02_test_json_flow_single_step.json");
  ...
  public void willDeserializeA_MultiSteps() throws Exception {
    String jsonDocumentAsString =
        smartUtils.getJsonDocumentAsString("01_unit_test_jsons/03_test_json_flow_multi_step.json");
    ScenarioSpec scenarioDeserialized = mapper.readValue(jsonDocumentAsString, ScenarioSpec.class);
  ...
  public void shouldSerializeSingleFlow() throws Exception {
    ...
    /**
     * Note: jayway json assertEquals has issues if json doc has got comments. So find out how to
     * ignore or allow comments
     */
  ...
  public void test_ignoreStepFailuresField() throws Exception {
    String jsonDocumentAsString =
        smartUtils.getJsonDocumentAsString(
            "01_unit_test_jsons/04_ignoreStepFailures_in_multistep.json");
    ScenarioSpec scenarioSpec = mapper.readValue(jsonDocumentAsString, ScenarioSpec.class);
  ...
  public void testSerDe_parameterized() throws Exception {
    String jsonDocumentAsString =
        smartUtils.getJsonDocumentAsString("01_unit_test_jsons/09_scenario_parameterized.json");
    ScenarioSpec scenarioSpec = mapper.readValue(jsonDocumentAsString, ScenarioSpec.class);
