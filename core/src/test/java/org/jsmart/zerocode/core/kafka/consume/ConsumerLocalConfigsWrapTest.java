...
public class ConsumerLocalConfigsWrapTest {
  ...
  public void testSerDeser() throws IOException {
    ConsumerLocalConfigsWrap javaObject =
        new ConsumerLocalConfigsWrap(
            new ConsumerLocalConfigs(
                "RAW", "RAW:/target/ttt", true, null, true, 3, 50L, "1,0,test-topic"));
    ObjectMapper objectMapper = new ObjectMapperProvider().get();
    ...
    ConsumerLocalConfigsWrap javaPojo =
        objectMapper.readValue(json, ConsumerLocalConfigsWrap.class);
  ...
  public void testSerDeser_oneFieldOnly() throws IOException {
    ConsumerLocalConfigsWrap javaObject =
        new ConsumerLocalConfigsWrap(
            new ConsumerLocalConfigs(
                "RAW", "JSON:/target/ttt", null, null, false, 3, null, "1,0,test-topic"));
