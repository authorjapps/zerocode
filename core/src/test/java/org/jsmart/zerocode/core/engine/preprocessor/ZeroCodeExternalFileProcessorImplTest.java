...
public class ZeroCodeExternalFileProcessorImplTest {
  ...
  private ZeroCodeExternalFileProcessorImpl externalFileProcessor =
      new ZeroCodeExternalFileProcessorImpl(objectMapper);
  ...
  public void test_wrongFileException() throws IOException {
    ...
    Map<String, Object> map =
        objectMapper.readValue(jsonAsString, new TypeReference<Map<String, Object>>() {});
  ...
  public void test_NoExtJsonFile() throws IOException {
    String jsonAsString =
        readJsonAsString("filebody_unit_test/json_step_no_ext_json_test_file.json");
    Map<String, Object> map =
        objectMapper.readValue(jsonAsString, new TypeReference<Map<String, Object>>() {});
  ...
  public void test_NoExtFileCheckDigNeeded() throws IOException {
    ...
    jsonAsString =
        readJsonAsString("filebody_unit_test/json_step_text_node_ext_json_file_test.json");
