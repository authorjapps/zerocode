...
public class JunitUsualWithZerocodeUnitTest {
  ...
  @Ignore(
      "Pure JUnit failure - Un-Ignore this to run manually to view the failure report in CSV format")
  @Test
   ...
   * simulators/test_purpose_end_points.json. @RunWith(TestOnlyZeroCodeUnitRunner.class) : starts
   * these mocks first before running the tests
   */
  @Test
