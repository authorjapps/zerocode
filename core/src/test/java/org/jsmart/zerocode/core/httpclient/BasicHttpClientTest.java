...
public class BasicHttpClientTest {
  ...
  public void createRequestBuilder() throws IOException {
    ...
    RequestBuilder requestBuilder =
        basicHttpClient.createRequestBuilder("/api/v1/founder", "POST", header, reqBodyAsString);
  ...
  public void createRequestBuilder_frontSlash() throws IOException {
    String reqBodyAsString =
        "{\"state/region\":\"singapore north\",\"Company\":\"Amazon\",\"Title\":\"CEO\"}";
    RequestBuilder requestBuilder =
        basicHttpClient.createRequestBuilder("/api/v1/founder", "POST", header, reqBodyAsString);
    String nameValuePairString = EntityUtils.toString(requestBuilder.getEntity(), "UTF-8");
  ...
  public void createRequestBuilder_jsonValue() throws IOException {
    ...
    assertThat(
        nameValuePairString,
        is("Company=Amazon&addresses=%7Bcity%3DNewYork%2C+type%3DHeadOffice%7D"));
  }

  @Test
  public void test_emptyQueryParams() throws IOException {
    String effectiveUrl =
        basicHttpClient.handleUrlAndQueryParams("http://test-url", new HashMap<>());
  ...
  public void test_multipart_without_file() throws IOException {
    basicHttpClient.createFileUploadRequestBuilder(
        "http://test-url", "POST", "{\"modelStorage\":\"DB\",\"sketchingAlgorithm\":\"UPDATE\"}");
  }
  ...
  public void willMockUTF8Response() throws Exception {
    ...
    BasicHttpClient basicHttpClient = new BasicHttpClient();
    final String responseBodyActual =
        (String) basicHttpClient.handleResponse(closeableHttpResponse).getEntity();
