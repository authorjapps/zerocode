...
public class JavaMethodExecutorImplTest {
  ...
  public void willFind_matchingMethod() throws Exception {
    ...
    assertThat(
        matchingMethod.getDeclaringClass().getName(), is("org.jsmart.zerocode.core.AddService"));
  ...
  public void willExecuteA_Java_Method() throws Exception {
    ...
    final Object result =
        methodExecutor.executeWithParams("org.jsmart.zerocode.core.AddService", "add", 1, 2);
  ...
  public void test_noMatchingMethod_exception() throws Exception {
    ...
    expectedException.expectMessage(
        "Java exec(): No matching method invalidMethod found in class org.jsmart.zerocode.core.AddService");
  ...
  public void willExecuteJsonRequestForJavaMethod_noParam() throws Exception {
    String scenariosJsonAsString =
        SmartUtils.readJsonAsString(
            "05_test_java_service/02_test_json_java_service_method_no_param.json");
  ...
  public void willExecuteJsonRequestFor_java_method_viaDsl() throws Exception {
    String scenariosJsonAsString =
        SmartUtils.readJsonAsString(
            "05_test_java_service/01_test_json_java_service_method_Integer.json");
    final ScenarioSpec scenarioSpec =
        smartUtils.getMapper().readValue(scenariosJsonAsString, ScenarioSpec.class);
  ...
  public void willExecuteJsonRequestFor_CustomObject_java_method() throws Exception {
    String scenariosJsonAsString =
        SmartUtils.readJsonAsString(
            "05_test_java_service/01_test_json_java_service_method_MyNumber.json");
    final ScenarioSpec scenarioSpec =
        smartUtils.getMapper().readValue(scenariosJsonAsString, ScenarioSpec.class);
