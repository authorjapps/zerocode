...
public class SslTrustCorporateProxyHttpClient extends BasicHttpClient {
  private static final Logger LOGGER =
      LoggerFactory.getLogger(SslTrustCorporateProxyHttpClient.class);
  ...
  public CloseableHttpClient createHttpClient()
    ...
    LOGGER.info(
        "###Used SSL Enabled Http Client with Corporate Proxy, for both Http and Https connections");
    ...
    CredentialsProvider credsProvider =
        createProxyCredentialsProvider(proxyHost, proxyPort, proxyUserName, proxyPassword);
