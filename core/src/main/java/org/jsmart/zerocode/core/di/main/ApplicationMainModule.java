...
public class ApplicationMainModule extends AbstractModule {
  ...
  public Properties getProperties(String host) {
    ...
    try {
      ...
      LOGGER.info(
          "###Oops!Exception### while reading target env file: "
              + host
              + ". Have you mentioned env details?");
      throw new RuntimeException(
          "could not read the target-env properties file --" + host + "-- from the classpath.");
    }
