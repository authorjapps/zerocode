...
public class KafkaProducerHelper {
  ...
  public static Producer<Long, String> createProducer(
      String bootStrapServers, String producerPropertyFile) {
  ...
  public static ProducerRecord prepareJsonRecordToSend(
      String topicName, ProducerJsonRecord recordToSend) {
  ...
  public static String readRecordType(String requestJson, String jsonPath) {
    try {
      ...
      LOGGER.warn(
          "Could not find path '" + jsonPath + "' in the request. returned default type 'RAW'.");
      return RAW;
    }
  }
}
