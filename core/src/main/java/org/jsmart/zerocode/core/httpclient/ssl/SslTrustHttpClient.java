...
public class SslTrustHttpClient extends BasicHttpClient {
   ...
   * connections. Sometimes you may not need a SSLContext, sometimes you need one, some other times
   * you need a simple default http client e.g. HttpClients.createDefault() provided by Apache.
   *
   * <p>If you do not override this method, the framework creates a http client suitable for both
   * http/https.
   */
  @Override
