...
public class ConsumerLocalConfigsWrap {
  ...
  @JsonCreator
  public ConsumerLocalConfigsWrap(
      @JsonProperty("consumerLocalConfigs") ConsumerLocalConfigs consumerLocalConfigs) {
  ...
  public String toString() {
    return "ConsumerLocalConfigsWrap{" + "consumerLocalConfigs=" + consumerLocalConfigs + '}';
  }
}
