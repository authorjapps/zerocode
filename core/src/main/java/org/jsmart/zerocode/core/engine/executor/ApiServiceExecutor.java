...
public interface ApiServiceExecutor {
   ...
   * @param methodName An HTTP method e.g. GET, PUT, POST, DELETE, HEAD etc supported by Apache
   *     HttpClient
   ...
   */
  String executeKafkaService(
      String kafkaServers, String kafkaTopic, String methodName, String requestJson);
}
