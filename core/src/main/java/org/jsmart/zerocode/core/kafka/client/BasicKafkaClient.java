...
public class BasicKafkaClient {
  ...
  @Inject private KafkaSender sender;

  @Inject private KafkaReceiver receiver;
      ...
      switch (operation) {
        ...
        default:
          throw new RuntimeException(
              "Unsupported. Framework could not assume a default Kafka operation");
      }

    } catch (Throwable exx) {

      LOGGER.error(
          "Exception during operation:{}, topicName:{}, error:{}",
          operation,
          topicName,
          exx.getMessage());
