...
public class HttpApiExecutorImpl implements HttpApiExecutor {
  ...
  @Inject private SmartUtils smartUtils;
  ...
  public String execute(String httpUrl, String methodName, String requestJson) throws Exception {
    ...
    Response zeroCodeResponse =
        deriveZeroCodeResponseFrom(responseStatus, responseHeaders, responseBodyAsString);
  ...
  private Response deriveZeroCodeResponseFrom(
      int responseStatus, MultivaluedMap responseHeaders, String responseBodyAsString)
      throws IOException {
  ...
  private boolean completedMockingEndPoints(
      String httpUrl, String requestJson, String methodName, Object bodyContent)
