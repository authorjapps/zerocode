...
public class WireMockJsonContentTesting {
  ...
  public void bioViaJson() throws Exception {
    ...
    givenThat(
        WireMock.get(
                urlEqualTo(
                    "/identitymanagement-services/identitymanagement-services/person/internalHandle/person_id_009/biographics/default"))
            .willReturn(
                aResponse()
                    .withStatus(200)
    ...
    ClientRequest clientExecutor =
        httpClientExecutor.createRequest(
            "http://localhost:9073/identitymanagement-services/identitymanagement-services/person/internalHandle/person_id_009/biographics/default");
