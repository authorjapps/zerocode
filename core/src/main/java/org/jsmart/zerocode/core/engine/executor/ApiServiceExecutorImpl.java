...
public class ApiServiceExecutorImpl implements ApiServiceExecutor {
  ...
  @Inject private JavaMethodExecutor javaMethodExecutor;

  @Inject private HttpApiExecutor httpApiExecutor;

  @Inject private BasicKafkaClient kafkaClient;
  ...
  public String executeHttpApi(String url, String methodName, String requestJson) {
    try {
      ...
      LOGGER.error(
          "Ooooooooooops! Something unexpected happened while connecting to the url:{} "
  ...
  @Override
  public String executeKafkaService(
      String kafkaServers, String kafkaTopic, String operation, String requestJson) {
