package org.jsmart.zerocode.jupiter;
...
public class ZeroCodeJupiterLoad implements BeforeEachCallback {
    private static final Logger LOGGER = LoggerFactory.getLogger(ZeroCodeJupiterLoad.class);
    ...
    public void beforeEach(ExtensionContext extensionContext) throws Exception {
        ...
        //-------------------------------------------
        boolean chartAndDashBoardGeneration = false;
        ...
        if (chartAndDashBoardGeneration) {
    ...
    private String validateAndGetLoadPropertiesFile(Class<?> testClass, Method method) {
        ...
        throw new RuntimeException(
                format("\n<< Ah! You missed to put the @LoadWith(...) on the Class '%s' or Method '%s' >> ",
